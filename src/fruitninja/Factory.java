...
public class Factory {
    ...
    public Factory(GraphicsContext gc, Scene scene) throws ParserConfigurationException, SAXException, IOException {
        ...
        p = new Player(this,gc,scene);
        login = new Login(this,gc,scene);
    }
    ...
    public void playerOptions(){
        ...
        gc.setFill(Color.BURLYWOOD);
        gc.setFont(Font.font(35));
        gc.fillText("Log in", 200, 170);
        gc.fillText("Sign up", 200, 270);
    }
    public void loginOptions(){
        ...
        gc.setFill(Color.BLACK);
        gc.fillRect(110, 150, 180, 50);
        gc.fillRect(110, 250, 180, 50);
        gc.fillRect(110, 350, 180, 50);
        gc.setFill(Color.BURLYWOOD);
        gc.setFont(Font.font(35));
        gc.fillText("USERNAME", 200, 170);
        gc.fillText("PASSWORD", 200, 270);
        gc.fillText("LOGIN", 200, 370);
    }
